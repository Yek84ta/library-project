...
public class Library {
    ...
    public void borrowBook (String title) throws BookNotFoundException, EmptyLibraryException{
        ...
        System.out.println("The book" + books.toString() + " has been successfully delivered to you. Enjoy your reading!");
    ...
    public void returnBook(String title) throws BookNotFoundException{
        ...
        System.out.println("The book" + books.toString() + " has been successfully returned to the library. Thank you for returning it on time!");
    }
